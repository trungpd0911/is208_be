...
<h1 align="center"><b>Quản lí sổ đầu bài THPT MNO Backend</b> </h1>

## Overview

-   **Quản lí sổ đầu bài THPT MNO** is a website used for managing the student's homework notebook in high school. 
-   This repository is the API for the website.
-   Technology in use: NestJS, Mongoose - MongoDB, Swagger, JWT.
